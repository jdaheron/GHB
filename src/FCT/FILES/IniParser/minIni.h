...
//#include "minGlue.h"
#include <FILES/IniParser/minGlue-FatFs.h>
#include "BSP.h"
...
int   ini_gets_OpenedFile(const mTCHAR *Section, const mTCHAR *Key, const mTCHAR *DefValue, mTCHAR *Buffer, int BufferSize, INI_FILETYPE* pFile);
...
int   ini_getbool_OpenedFile(const mTCHAR *Section, const mTCHAR *Key, int DefValue, INI_FILETYPE* pFile);
int   ini_getsection(int idx, mTCHAR *Buffer, int BufferSize, const mTCHAR *Filename);
int   ini_getsection_OpenedFile(int idx, mTCHAR *Buffer, int BufferSize, INI_FILETYPE* pFile);
int   ini_getkey(const mTCHAR *Section, int idx, mTCHAR *Buffer, int BufferSize, const mTCHAR *Filename);
int   ini_getkey_OpenedFile(const mTCHAR *Section, int idx, mTCHAR *Buffer, int BufferSize, INI_FILETYPE* pFile);
...
int   ini_putl_OpenedFile(const mTCHAR *Section, const mTCHAR *Key, long Value, INI_FILETYPE* pFileRead, INI_FILETYPE* pFileWrite);
int   ini_puts(const mTCHAR *Section, const mTCHAR *Key, const mTCHAR *Value, const mTCHAR *Filename);
int   ini_puts_OpenedFile(const mTCHAR *Section, const mTCHAR *Key, const mTCHAR *Value, INI_FILETYPE* pFileRead, INI_FILETYPE* pFileWrite);
#if defined INI_REAL
