...
void TIM4_DeInit() {
	...
	TIM_Cmd(TIM4, DISABLE);								// Desactivation peripherique
	RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM4, ENABLE);	// Desactivation horloge
...
{
	TIM_CCxCmd(TIM4, MappingGpio[PinId].PARAM, TIM_CCx_Enable);
	//TIM_CtrlPWMOutputs(TIM4, ENABLE); // TIM1 et TIM8 seulement
}
...
{
	TIM_CCxCmd(TIM4, MappingGpio[PinId].PARAM, TIM_CCx_Disable);
	//TIM_CtrlPWMOutputs(TIM4, DISABLE); // TIM1 et TIM8 seulement
}
