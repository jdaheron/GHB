...
void TIM3_DeInit() {
	...
	TIM_Cmd(TIM3, DISABLE);									// Desactivation peripherique
	RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM3, ENABLE);	// Desactivation horloge
...
{
	TIM_CCxCmd(TIM3, MappingGpio[PinId].PARAM, TIM_CCx_Enable);
	//TIM_CtrlPWMOutputs(TIM3, ENABLE); // TIM3 et TIM8 seulement
}
...
{
	TIM_CCxCmd(TIM3, MappingGpio[PinId].PARAM, TIM_CCx_Disable);
	//TIM_CtrlPWMOutputs(TIM3, DISABLE); // TIM3 et TIM8 seulement
}
